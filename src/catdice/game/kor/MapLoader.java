...
//import catdice.game.kor.Tile;
//import catdice.game.kor.TileEnvironment;
//import org.newdawn.slick.SlickException;
//import org.newdawn.slick.util.ResourceLoader;
//
//
...
//	 * 
//	 * @param set
//	 *            The tileset to load from while loading maps
//	 */
...
//
//	/**
//	 * Load a map from the given resource reference. The map is parsed character
//	 * for character and a set of tiles equal to the size of the text file is
//	 * creatd.
//	 * 
//	 * @param ref
//	 *            The reference to the map to load
//	 * @return The configured environment thats been populated with tiles
//	 * @throws SlickException
//	 *             Indicates a failure to locate or read the tile map
//	 */
