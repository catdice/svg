...
public abstract class Actor extends AbstractEntity {
	/**
	 * The maximum velocity an actor can jump at - this is used to prevent some
	 * odd effects of a penetration based physics engine
	 */
	 ...
	 * @param mass
	 *            The mass of the actor's physics body
	 * @param size
	 *            The size of the actor's collision bounds
	 */
	...
	/**
	 * Apply force to the actor. This should be used to move the actor around
	 * the level
	 * 
	 * @param x
	 ...
	 * 
	 * @param moving
	 *            True if this actor is being moved
	 */
	...
	/**
	 * Implementation on ground check. This can be expensive so best to try and
	 * limit is use by caching
	 * 
	 * @param body
	 *            The body to check
